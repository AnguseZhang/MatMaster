...
# 初始化固态电解质研究代理
def init_solid_state_electrolyte_research_agent():
    ...
    root_agent = Agent(
        ...
        description="A solid state electrolyte research agent that can understand user's research questions and delegate research tasks to subagents including database queries, literature research, and data analysis.",
        sub_agents=[
            database_agent,
            deep_research_agent,
            # data_analysis_agent,
